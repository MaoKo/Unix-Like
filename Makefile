...
AS = fasm
DEFINE =
SRC = kfs_5.asm system.inc kernel.inc bitmap.inc apic.inc init.inc login.inc kbd.inc fonts.inc teletype.inc\
	...
	sockpoc.inc client.inc server.inc sqrt.inc md5.inc bomb.inc invopcode.inc showpid.inc print.inc
ELF = kfs_5
CFG = grub.cfg
ISO = iso
